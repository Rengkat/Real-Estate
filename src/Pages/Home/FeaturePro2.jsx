            ...
            <div
              ...
              <div className="flex relative">
                ...
                <div className=" absolute top-3 md:top-2 ml-1">
                  <h1 className="top-6 ml-4 text-darkBg font-semibold text-sm md:text-xl">
                    {display.title.substring(0, 18)}...
                  </h1>
                  <p className="ml-9 -mt-1 text-xs md:text-sm">
                    {display.location[1].name}
                  </p>
                </div>
              </div>
              {/* ...ICON.... */}
              <div className="icons flex justify-between py-2 md:pt-5">
                <div className="flex items-center space-x-1">
                  <MdOutlineBedroomChild /> <span>{display.rooms}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <MdOutlineBathtub /> <span>{display.baths}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <FaVectorSquare /> <span>{display.area.toFixed(1)}sqr</span>
                </div>
              </div>

              <img
                src={display?.coverPhoto?.url}
                alt=""
